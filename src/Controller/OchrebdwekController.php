...
class OchrebdwekController extends AbstractController
{
    ...
    public function index(Request $request,Security $security): Response
    {
        ...
        {$phoneNum=$this->usersRepository->findOneBy(['email' =>$event->getPatientemail()])->getPhoneNumber();
            ...
            $sid = "AC06e5605c4af770c4e04ab90c2bb273c5"; // Your Account SID from https://console.twilio.com
    $token = "ca2b1a4f1ff1a1095a9ab8704c56bcad"; // Your Auth Token from https://console.twilio.com
